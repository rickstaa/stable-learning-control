...
import numpy as np
import torch
from machine_learning_control.common.helpers import is_scalar
...
from machine_learning_control.utils.mpi_utils.mpi_tools import (
    mpi_statistics_scalar,
    proc_id,
)
from machine_learning_control.utils.serialization_utils import (
    convert_json,
    load_from_json,
    save_to_json,
)
    ...
    def __init__(
        ...
        Args:
            ...
            verbose_fmt (str, optional): The format in which the statistics are
                ...
                :mod:`~machine_learning_control.user_config` file.
