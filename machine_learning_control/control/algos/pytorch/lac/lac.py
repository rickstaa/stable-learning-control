...
# fmt: off
from machine_learning_control.control.algos.pytorch.policies.lyapunov_actor_critic import (LyapunovActorCritic)  # noqa: E501
# fmt: on
    ...
    def __init__(
        ...
        Args:
            ...
            actor_critic (torch.nn.Module, optional): The constructor method for a
                ...
                Defaults to :class:`~machine_learning_control.control.algos.pytorch.policies.lyapunov_actor_critic.LyapunovActorCritic`
                if ``use_lyapunov=True`` else :class:`~machine_learning_control.control.algos.pytorch.policies.soft_actor_critic.SoftActorCritic`
