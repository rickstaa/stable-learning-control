...
if __name__ == "__main__":
    ...
    output_activation = {}
    output_activation["actor"] = safe_eval(args.act_out_a, backend="tf")
    if not args.use_lyapunov:
        output_activation["critic"] = safe_eval(args.act_out_c, backend="tf")
    ac_kwargs = dict(
        hidden_sizes={
        ...
        activation={
            "actor": safe_eval(args.act_a, backend="tf"),
            "critic": safe_eval(args.act_c, backend="tf"),
        },
