...
sys.path.insert(
    ...
    os.path.abspath(
        os.path.join(
            os.path.dirname(__name__), "../../machine_learning_control/control"
        )
    ),
)
sys.path.insert(
    ...
    os.path.abspath(
        os.path.join(
            os.path.dirname(__name__), "../../machine_learning_control/hardware"
        )
    ),
)
sys.path.insert(
    ...
    os.path.abspath(
        os.path.join(
            os.path.dirname(__name__), "../../machine_learning_control/modeling"
        )
    ),
)
sys.path.insert(
    0,
    os.path.abspath(
        os.path.join(os.path.dirname(__name__), "../../machine_learning_control/simzoo")
    ),
)

# -- Project information -----------------------------------------------------
project = "machine_learning_control"
