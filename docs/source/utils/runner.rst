...
+---------+--------------------+------------------------------------------------------------------------------------------------------------------------------+
|         | `robustness_eval`_ | Utility used to evaluate the robustness of a trained policy against external disturbances and changes in initial conditions. |
+---------+--------------------+------------------------------------------------------------------------------------------------------------------------------+

.. _`test_policy`: ../control/control_utils.html#test-policy-utility
.. _`plot`: ../control/control_utils.html#plot-utility
.. _`robustness_eval`: ../control/control_utils.html#robustness-eval-utility
