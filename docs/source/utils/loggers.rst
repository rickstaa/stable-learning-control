...
To load an actor-critic model saved by a PyTorch BLC implementation, run:
...
When you use this method to restore a graph saved by a Tensorflow BLC implementation,
