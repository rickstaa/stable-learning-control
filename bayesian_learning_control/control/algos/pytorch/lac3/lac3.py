...
class LAC(nn.Module):
    ...
    def update(self, data):  # noqa: C901
        ...
        with torch.no_grad():
            ...
            # l_pi_targ = self.ac_targ.L1(o_, a2_)
            # l_backup = (
            ...
            l1_pi_targ = self.ac_targ.L1(o_, a2)
            l2_pi_targ = self.ac_targ.L2(o_, a2)
            l_pi_targ = torch.max(
                l1_pi_targ,
                l2_pi_targ,
        ...
        # lya_l_ = self.ac.L1(o_, a2)
        # l = l1

        # DEBUG: NEW CODE
        lya_l1_ = self.ac.L1(o_, a2)
        lya_l2_ = self.ac.L2(o_, a2)
