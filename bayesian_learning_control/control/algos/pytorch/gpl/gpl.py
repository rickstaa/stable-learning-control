...
# Import ray tuner if instealled
...
class GPL(nn.Module):
    ...
    def __init__(  # noqa: C901
        ...
        Args:
            ...
            actor_critic (torch.nn.Module, optional): The constructor method for a
                ...
                Defaults to :class:`~bayesian_learning_control.control.algos.pytorch.policies.lyapunov_actor_critic.LyapunovActorCritic`
                if ``use_lyapunov=True`` else :class:`~bayesian_learning_control.control.algos.pytorch.policies.soft_actor_critic.SoftActorCritic`
    ...
    def update(self, data):  # noqa: C901
        ...
        if self.use_lyapunov:
            ...
            # )  # See eq. 12
            a_loss = (
                self.alpha.detach() * logp_pi.mean() - q_pi - q_lya_pi
            )  # See eq. 12
        else:
