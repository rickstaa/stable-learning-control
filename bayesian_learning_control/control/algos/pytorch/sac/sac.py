...
wrapper runs the :mod:`~bayesian_learning_control.control.algos.pytorch.lac.lac.lac`
...
from bayesian_learning_control.control.algos.pytorch.lac.lac import LAC, lac
...
def apply_sac_defaults(args, kwargs):
    ...
    :mod:`bayesian_learning_control.control.algos.pytorch.sac.sac` defaults to the input
...
def sac(*args, **kwargs):
    ...
    :mod:`~bayesian_learning_control.control.algos.pytorch.lac.lac` algorithm with
