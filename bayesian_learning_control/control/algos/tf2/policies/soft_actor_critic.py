...
# fmt: off
from bayesian_learning_control.control.algos.tf2.policies.actors.squashed_gaussian_actor import \
    SquashedGaussianActor  # noqa: E501
from bayesian_learning_control.control.algos.tf2.policies.critics.Q_critic import \
    QCritic  # noqa: E501
# fmt: on
...
class SoftActorCritic(tf.keras.Model):
    ...
    Attributes:
        self.pi (:class:`~bayesian_learning_control.control.algos.tf2.policies.actors.SquashedGaussianActor`):
            The squashed gaussian policy network (actor).
        self.Q1 (:class:`~bayesian_learning_control.control.algos.tf2.policies.critics.QCritic`): The first soft Q-network (critic).
        self.Q1 (:class:`~bayesian_learning_control.control.algos.tf2.policies.critics.QCritic`); The second soft Q-network (critic).
    """  # noqa: E501
