...
from bayesian_learning_control.control.algos.tf2.policies.critics.L_critic import \
    LCritic  # noqa: E501
# fmt: on
...
class LyapunovActorCritic(tf.keras.Model):
    ...
    Attributes:
        self.pi (:class:`~bayesian_learning_control.control.algos.tf2.policies.actors.squashed_gaussian_actor.SquashedGaussianActor`):
            The squashed gaussian policy network (actor).
        self.L (:obj:`~bayesian_learning_control.control.algos.tf2.policies.critics.L_critic.LCritic`):
