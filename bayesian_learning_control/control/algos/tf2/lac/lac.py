    ...
    def __init__(  # noqa: C901
        ...
        Args:
            ...
            actor_critic (tf.Module, optional): The constructor method for a
                ...
                Defaults to :class:`~bayesian_learning_control.control.algos.tf2.policies.lyapunov_actor_critic.LyapunovActorCritic`
                if ``use_lyapunov=True`` else :class:`~bayesian_learning_control.control.algos.tf2.policies.soft_actor_critic.SoftActorCritic`
